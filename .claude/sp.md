...
- Write only what the I needs in order to understand or act.
...
- Do not quote exact figures where they add nothing
- Do not use padding phrases and throat-clearing.
- Do not explain what the reader already knows, and don't restate the diff.
